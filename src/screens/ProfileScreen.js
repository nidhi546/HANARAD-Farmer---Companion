...
export default function ProfileScreen({ navigation }) {
  ...
  const infoItems = [
    {
      icon: "🛰️",
      label: t("nasaPowerLabel"),
      value: versionLabel || t("nasaPowerDesc"),
    },
  ...
  const handleLogout = () => {
    Alert.alert(t("logoutConfirmTitle"), t("logoutConfirm"), [
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.profileHeader}>
        ...
        <Text style={styles.userName}>{user?.username || t("farmer")}</Text>
